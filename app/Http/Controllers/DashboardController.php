...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        if (auth()->user()->level == 1) {
            return view('admin.dashboard', compact('kategori', 'trx_studi_kelayakan', 'trx_perencanaan_proyek', 'trx_desain_sistem', 'trx_post_implementation_review', 'produk', 'supplier', 'member', 'tanggal_awal', 'tanggal_akhir', 'data_tanggal', 'data_pendapatan'));
        } else {
