        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <textarea name="latar_belakang" id="latar_belakang" class="form-control" rows="3" readonly></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <textarea name="tujuan" id="tujuan" class="form-control" rows="3" readonly></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <textarea name="target_implementasi_sistem" id="target_implementasi_sistem" class="form-control" rows="4" readonly></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <textarea name="fungsi_sistem_informasi" id="fungsi_sistem_informasi" class="form-control" rows="3" readonly></textarea>
                    </div>
                </div>
