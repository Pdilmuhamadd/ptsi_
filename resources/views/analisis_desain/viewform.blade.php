    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalViewLabel">Lihat Permintaan Pengembangan</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <textarea name="deskripsi_proyek" id="deskripsi_proyek" class="form-control" rows="3" readonly></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <textarea name="manajer_proyek" id="manajer_proyek" class="form-control" rows="3" readonly></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <textarea name="kebutuhan_fungsi" id="kebutuhan_fungsi" class="form-control" rows="4" readonly></textarea>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="gambaran_arsitektur" class="col-lg-2 col-lg-offset-1 control-label">Gambaran Arsitektur</label>
                    <div class="col-lg-6">
                        <input type="text" name="gambaran_arsitektur" id="gambaran_arsitektur" class="form-control" readonly>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="detil_arsitektur" class="col-lg-2 col-lg-offset-1 control-label">Detil Arsitektur</label>
                    <div class="col-lg-6">
                        <input type="text" name="detil_arsitektur" id="detil_arsitektur" class="form-control" readonly>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="lampiran_mockup" class="col-lg-2 col-lg-offset-1 control-label">Tanggal Disiapkan</label>
                    <div class="col-lg-6">
                        <input type="text" name="lampiran_mockup" id="lampiran_mockup" class="form-control" readonly>
                    </div>
                </div>
